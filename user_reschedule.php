...
$query = "
    SELECT rr.reschedule_id, rr.schedule_id, rr.reason, rp.new_schedule_day, ps.collection_time
    FROM reschedule_requests rr
    JOIN pickup_schedules ps ON rr.schedule_id = ps.schedule_id
    JOIN rescheduled_pickups rp ON rr.schedule_id = rp.schedule_id
    WHERE rr.user_id = ? AND LOWER(rr.status) = 'approved'
";
